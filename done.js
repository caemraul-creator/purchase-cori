...
// ======================
// LOAD DATA - SEDERHANA SEPERTI AWAL
// ======================
function loadData() {
  loadDataOptimized((data) => {
    // TAMPILKAN SEMUA DATA dari sheet DONE, tanpa filter status
    allData = data || [];
...
function renderTable() {
  ...
  if (!pageData.length) {
    tbody.innerHTML = `<tr><td colspan="${headers.length}" class="text-center">Tidak ada data</td></tr>`;
    return;
  }
